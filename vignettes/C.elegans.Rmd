...
graph <- igraph::read_graph(
     "D:/projects/lineage tracing/FateScape/FateScape/data/C.elegans/cell_lineage_tree.gml",
     format = "gml"
 )
MetaData <- read.csv("D:/projects/lineage tracing/FateScape/FateScape/data/C.elegans/MetaData.csv")
```
...
barcodes_dropout <- FateScape:::stochastic_dropout(barcodes_initial, p_ds)
```
